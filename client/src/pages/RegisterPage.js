...
export default function RegisterPage(){
    ...
    async function register(event){
        ...
        const response = await fetch('https://dailytech-backend.onrender.com/auth/register', {
            method: 'POST',
        ...
        if(response.status === 200){
            ...
            const response = await fetch('https://dailytech-backend.onrender.com/auth/login', {
                method: 'POST',
